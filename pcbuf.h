...
/**
 * @file pcbuf.h
 * @brief Two-phase circular buffer implementation for producer/consumer separation.
 *
 ...
 * @cb: Pointer to the pc_buf structure.
 *
 * This function updates the commit head to the current staging head, making
