				  ...
				  size_t top_sz)
{
	...
	o->num_regions = le32_to_cpu(o->num_regions);
	o->over_provisioning.u.f = fio_uint64_to_double(le64_to_cpu(top->over_provisioning.u.i));
				   ...
				   struct thread_options *o)
{
	...
	top->num_regions = cpu_to_le32(o->num_regions);
	top->over_provisioning.u.i = __cpu_to_le64(fio_double_to_uint64(o->over_provisioning.u.f));
