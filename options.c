...
struct fio_option fio_options[FIO_MAX_OPTS] = {
	...
	{
		.name	= "num_regions",
		.lname	= "Number of regions",
		.type	= FIO_OPT_INT,
		.off1	= offsetof(struct thread_options, num_regions),
	...
	{
		.name	= "over_provisioning",
		.lname	= "Over provisioning",
		.type	= FIO_OPT_FLOAT_LIST,
		.off1	= offsetof(struct thread_options, over_provisioning),
